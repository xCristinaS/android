...
public class BddContract {
    ...
    public static abstract class Alumno implements BaseColumns {
        ...
        public static final String[] TODOS = new String[]{ID, FOTO, NOMBRE, CURSO, TELEFONO, DIRECCION, EDAD, EMPRESA};
    }
    ...
    public static abstract class Visitas implements BaseColumns {
        ...
        public static final String[] TODOS = new String[]{ID_ALUMNO, FECHA, COMENTARIO};
    }
}
